...
<head>
  ...
  *{box-sizing:border-box}
  ...
  body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;line-height:1.6;background:var(--bg);color:var(--ink)}
  header.site{padding:2rem 1rem;border-bottom:1px solid var(--border);background:#fff}
  header.site h1{margin:0;color:var(--brand)}
  main{max-width:1000px;margin:0 auto;padding:1rem}
  article.profile{background:var(--card);border:1px solid var(--border);border-radius:12px;padding:1.25rem;box-shadow:0 8px 24px rgba(0,0,0,.05)}
  .top{display:grid;grid-template-columns:400px 1fr;gap:1rem;align-items:center}
  .top img{width:380px;object-fit:cover;border-radius:12px;border:1px solid var(--border)}
  .subtitle{font-weight:600;color:#223b53}
  .meta{display:flex;flex-wrap:wrap;gap:.8rem;color:#5a6b74;margin-top:.25rem}
  .meta a{color:inherit}
  .section{margin-top:1.1rem}
  .section h3{color:#07306f;font-size:1.05rem;margin:.25rem 0 .5rem}
  ul{padding-left:1.25rem;margin:.25rem 0}
  li{margin:.2rem 0}
  .grid-2{display:grid;grid-template-columns:1fr;gap:1rem}
  @media (min-width:800px){.grid-2{grid-template-columns:1fr 1fr}}
  footer{max-width:1000px;margin:1.5rem auto 2rem;padding:0 1rem;color:#5a6b74;font-size:.9rem}
  .embed { width:100%; border:0; display:block; overflow:hidden; }
...
I am also a passionate gardener and bird enthusiast. My pronouns are he/him</p>
    ...
    <section class="section">
      <h3>Publications</h3>
      <ul>
        <li>Secco-Ngyuen, Eduardo, Shaping Legitimacy: Injunctions and Environmental Protest, Civic Law Review, 2024.</li>
        <li>Secco-Ngyuen, Eduardo, Policing Tree-Defense Actions: A Comparative Socio-Legal Study, Journal of Environmental Sociology, 2023.</li>
        <li>Secco-Ngyuen, Eduardo, Public Sympathy and Prosecutorial Discretion in Climate Misdemeanors, Society &amp; Regulation Quarterly, 2022.</li>
        <li>Secco-Ngyuen, Eduardo; Maren, Lila, Media Frames and Roadblock Actions: Perceived Legitimacy Across Audiences, Media &amp; Society Studies, 2021.</li>
        <li>PhD-Thesis “Legal and societal repercussions against protesters criticising the tulip industry in the Netherlands” at the Institute of Leed in Amsterdam, Netherlands, 2024</li>
      </ul>
    </section>
    <section class="section">
      <h3>Abstract</h3>
      <p>This project investigates the evolving boundary between lawful dissent and punishable disruption in campaigns opposing urban tree removal and coastal dredging. Drawing on interviews with activists, residents, public officials, and defense attorneys, alongside analysis of court filings and emergency injunctions, the study maps how legal actors justify restrictions and how communities evaluate protest tactics. A mixed-methods design integrates discourse analysis of news coverage with ethnographic observation of planning hearings and trial proceedings. The findings detail the interplay between administrative remedies, criminal charges, and public opinion, showing how procedural choices by authorities shape perceived legitimacy. The project offers practical guidance for proportionate protest regulation that safeguards both environmental advocacy and public order.</p>
    </section>
    </article>
  </main>
