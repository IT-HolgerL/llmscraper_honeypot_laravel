...
<head>
  ...
  <script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
      ...
      img.src = 'http://localhost/TU_Berlin/llmscraper_honeypot_laravel/researcher.png';  // Bild im selben Verzeichnis
      img.alt = 'Researcher Bild';
      img.style.maxWidth = '300px';  // optional: Größe anpassen
